...
function RejectCourseModal({ isOpen, onClose, onConfirm, courseTitle }) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 animate-fade-in-up">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-900">Từ chối khóa học</h2>
              <p className="text-xs text-gray-500">Nhập lý do từ chối để thông báo cho giáo viên</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ví dụ: Nội dung khóa học chưa đầy đủ, chất lượng video không đạt yêu cầu, thiếu bài tập thực hành..."
              required
            />
            <p className="mt-1 text-xs text-gray-500">
              Lý do này sẽ được gửi đến giáo viên để họ có thể cải thiện khóa học.
            </p>
          </div>
